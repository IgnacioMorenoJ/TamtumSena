<%@include file="header.jsp" %>
  ...
  <form method="post" action="UsuarioController?accion=add">
  	...
  	<div class="form-group">
  		...
  		<input type="text" class="form-control" name="nodoc" id="nodoc" placeholder="Ingrese el No. de Documento"/>
  	</div>
  	...
  	<div class="form-group">
  		...
  		<input type="password" class="form-control" name="password" id="password" placeholder="Ingrese el Apellido"/>
  	</div>
  	
<!--  	 <div class="form-group">
  	  <label>Rol de Usuario</label>
           
                <select class="form-select" aria-label="Default select example" name="rolusu">
